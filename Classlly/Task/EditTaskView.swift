...
struct EditTaskView: View {
    ...
    @State private var isFlagged: Bool // For the "Flagged" feature
    ...
    init(task: StudyTask) {
        ...
        _isFlagged = State(initialValue: task.isFlagged) // For the "Flagged" feature
    }
        ...
        NavigationView {
            Form {
                    ...
                    Toggle(isOn: $isFlagged) {
                        HStack {
                            Image(systemName: "flag.fill")
                                .foregroundColor(.themeWarning) // Use theme color
                            Text("Flag task")
                        }
                    }
                    // --- END OF ADD ---
                ...
                Section {
                    ...
                    .foregroundColor(.themeError) // Use theme color
                }
            }
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    Button("Save") {
                        ...
                        task.isFlagged = isFlagged // Save the flag
                        dismiss()
                    }
